  ...
  return (
    <>
      ...
      <div className="min-h-[200vh] w-full pt-[50px]">
        ...
        <div className={`transition-all h-[60px] w-full fixed left-0 backdrop-blur-[40px] ${showTab ? "top-[0px]" : "top-[-65px]"}  z-[5]`}>
        ...
        <div className="md:px-[50px] px-[15px] w-full max-w-[800px] mx-auto">
          ...
          <div className="mt-[20px] md:text-[22px] text-[19px] font-[Satoshi]">
            <p className="text-center">I'm a software engineer building</p>
            <div className="max-w-[500px] mx-auto w-full">
              ...
              <div className="pt-[16px] flex justify-end gap-[15px] items-end md:text-[14px] text-[12px]">
        ...
        <div className="flex flex-col md:flex-row gap-[20px] w-full md:px-[50px] px-[15px]">
          <div className="flex-3">
            <h1 className="font-[Poppins] font-[500] text-[28px]">Projects</h1>
            <div className="grid md:grid-cols-3 grid-cols-1 mt-[10px] gap-[15px]">

              <div className="p-[5px] rounded-[10px] h-[320px] flex flex-col justify-between border-[1px] border-foreground/20 dark:bg-[#101010] bg-muted relative">
                <ArrowUpRight size={16} className="absolute top-[8px] right-[8px] text-white mix-blend-difference" />
                <div>
                  <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-Fy7qvtx5nD2CBkCduocnrVk8NgaVczBmjQ&s" className="w-full rounded-[5px] h-[180px]" unoptimized alt="" height={100} width={200} />
                  <div className="px-[6px]">
                    <h1 className="text-[22px] leading-[1.1em] mt-[8px]">Project name</h1>
                    <p className="text-[14px] opacity-[0.8] font-[400] mt-[2px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, sed!</p>
                  </div>
                </div>

                <div className="flex gap-[5px] justify-end">
                  <Button variant="outline" className="border-[1px] h-[37px]">View details</Button>
                  <Button>Visit <ArrowUpRight /></Button>
                </div>
              </div>
